...
function get_discord_string(anime_list: AnimeContent[]):string {
...
function DiscordFormatter({anime_list}: DiscordFormatterProps) {
    return <Button onClick={() => navigator.clipboard.writeText(get_discord_string(anime_list))}>Copy Discord string to clipboard</Button>
}
